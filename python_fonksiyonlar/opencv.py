# İlk önce pip 'i indirip yükleyiniz
# https://bootstrap.pypa.io/get-pip.py adresinden indirip C: ye atınız
# Başlat-Çalıştır-cmd yazıp komut satırın girip
# python get-pip.py yazıp kuralım
